                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->Name_Section_en }}">
                                                                                                <input id="id"
                                                                                                       type="hidden"
                                                                                                       name="id"
                                                                                                       class="form-control"
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        {{ csrf_field() }}
                                         <div class="row">
                                            <div class="col">
                                                <label>اسم المرحلة بالعربية</label>
                                                <select name="Name_Section" class="btn btn-primary form" style="font-size: 20px" >
                                            ...
                                            <div class="col">
                                                <label>Section Name In Englesh</label>
                                                <select name="Name_Section_en" class="btn btn-primary form" >
