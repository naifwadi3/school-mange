        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        ...
                        <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
                            <li class="gg-notes"><a href="{{route('Grade')}}">{{trans('main_trans.Grades_list')}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('class')}}"><i class="gg-notes"></i>{{trans('main_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('section') }}">{{trans('main_trans.List_sections')}}</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    <li> <a href="{{route('studant.create')  }}">{{trans('main_trans.add_student')}}</a></li>
                                    <li> <a href="{{route('studant.index')  }}">{{trans('main_trans.list_students')}}</a></li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ url('Teacher') }}">{{trans('main_trans.List_Teachers')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('fee.index') }}">{{trans('main_trans.study_fees')}}</a> </li>
                            <li> <a href="{{ route('fee.create') }}">{{trans('main_trans.Invoices')}}</a> </li>
                            <li> <a href="">{{trans('main_trans.receipt')}}</a> </li>
                            <li> <a href="">{{trans('main_trans.exclude_fee')}}</a> </li>
                            <li> <a href="">{{trans('main_trans.voucher_exchange')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                            <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('main_trans.study_subject_list')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('subject.index') }}">{{trans('main_trans.study_subject_list')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Exams-icon">
                            <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">اهاه</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Exam.index') }}">قائمة الامتحانات</a> </li>
                            <li> <a href="">قائمة الاسئلة</a> </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#ََQuizze-icon">
                            <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{ trans('main_trans.exams') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="ََQuizze-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Quizzes.index') }}">{{ trans('main_trans.exams_list') }}</a> </li>
                            <li> <a href="">{{ trans('main_trans.exams_Q') }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('online_classes.index') }}">{{trans('main_trans.Onlineclasses')}}</a> </li>
                        </ul>
                    </li>
