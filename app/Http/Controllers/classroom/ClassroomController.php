...
class ClassroomController extends Controller
{
    ...
    public function index()
    {
        ...
        $Grades = Grade::all();
        return view('pages.classroom.My_Classes', compact('My_Classes', 'Grades'));



        // $Grades=Grade::all();
    //     $Grades = Classroom::with(array('Grade'=>function($query){
    //         $query->select('id','name');
    //     }))->get();
    // return view('pages.classroom.My_Classes',compact('Grades','My_Classes'));
