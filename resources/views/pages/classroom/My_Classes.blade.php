        ...
        <div class="card-body">
            ...
            <br><br>
                 ...
                 <form action="{{ route('Filter_Classes') }}" method="POST">
                    @csrf
                    @method('POST')
                    <select class="btn btn-primary" class="selectpicker" data-style="btn-info" name="Grade_id" required
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                class="mr-sm-2">{{ trans('My_Classes_trans.Name_class') }}
                                                :</label>
                                                <select name="Name_class" class="fancyselect">
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_en') }}
                                                :</label>
                                                <select name="Name_class_en" class="fancyselect">
                                                    <option value="First grade"> First grade </option>
                                                    <option value="middle School"> Second grade </option>
