...
return [
    ...
    'add_Promotion'=>'ترقية الطلاب',
    'list_Promotions'=>'قائمة الترقية',
    'study_fees'=>'رسوم الطالب',
    'Invoices'=>'الفواتير',
    'receipt'=>'إيصال',
    'exclude_fee'=>'استثناء الرسوم',
    'voucher_exchange'=>'صرف القسيمة',
    'student_list' => 'قائمة الطلاب',
    'study_subject_list'=>'قائمة المواد الدراسية',
    'exams'=>'الاختبارات',
    'exams_list'=>'قائمة الاختبارات',
    'exams_Q'=>'اسئلة الامتحانات',
